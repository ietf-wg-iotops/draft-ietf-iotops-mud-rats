...
Discussion of this work occurs on the [IOT Operations
Working Group mailing list](mailto:iotops@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/iotops/),
[subscribe](https://www.ietf.org/mailman/listinfo/iotops)).
...
[Working Group documents](https://datatracker.ietf.org/wg/iotops/documents/).
